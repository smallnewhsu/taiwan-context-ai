...
| 模組 | 輸入 | 核心功能 | 輸出 |
|---|---|---|---|
| **聲入其境** | 即時錄音或音檔 | Taiwan Tongues ASR CE辨識國語、台語、客語、英語及混合語音，再結合人物關係與前後文 | 辨識話語、字面意思、可能意境、判斷依據、建議回應 |
...
| 指標 | Qwen2.5 3B歷史基準 | Qwen2.5 1.5B目前版本 |
|---|---:|---:|
| 測試案例 | 12 | 12 |
| 自動安全通過率 | 100% | 100% |
| LLM候選採用率 | 41.67% | 41.67% |
| 穩態平均延遲 | 1.155秒 | 0.673秒 |
| 穩態P95 | 1.356秒 | 0.852秒 |

在安全通過率與候選採用率維持不變的情況下，1.5B穩態平均延遲降低約41.7%。3B人工評測整體平均為4.92/5；1.5B人工評測尚待擴充，不沿用3B分數。
...
- 聲入其境：<http://127.0.0.1:8000/app/speech/>
...
datasets/taiwan_context/ 詞彙、授權回饋與資料集版本
